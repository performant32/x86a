...
namespace x86a {
    ...
    I386::I386(){
        ...
        m_Registers.insert(std::make_pair("dx",  (Register){0b10, Register::Type::GeneralPurpose, 16}));
        m_Registers.insert(std::make_pair("edx", (Register){0b10, Register::Type::GeneralPurpose, 32}));
...
#undef CREATE_INSTRUCTION
    ...
    std::string_view I386::getEffectiveAddressName(EffectiveAddress address)const noexcept{
        switch(address){
            ...
            case EffectiveAddress::EDX:return "EDX";
